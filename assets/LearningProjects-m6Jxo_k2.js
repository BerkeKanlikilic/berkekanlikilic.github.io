import{P as n,a as s}from"./ProjectsList-D9uMsbtq.js";import{e as o,_ as c,c as r,a as t,d as l,r as p,o as g}from"./index-7slPQZdm.js";const d=[new n("learning-1","Tic-Tac-Toe","/img/projects/learning-1/tictactoe-icon-2.png",`
        <div class="paragraph">
        ...
        <div class="paragraph">
          <div class="notice">
            Windows build available on <a href="https://berkekanlikilic.itch.io/tic-tac-toe" target="_blank">itch.io</a>.
            Source code available on <a href="https://github.com/BerkeKanlikilic/Unity-Tic-Tac-Toe" target="_blank">GitHub</a>.
          </div>
        </div>
        ...
        `,"#232323",!1,!1,!0,!0,"https://berkekanlikilic.itch.io/tic-tac-toe","https://github.com/BerkeKanlikilic/Unity-Tic-Tac-Toe")],m=o({name:"LearningProjects",components:{ProjectsList:s},data:function(){return{projects:d}}});function h(a,e,u,T,b,f){const i=p("ProjectsList");return g(),r("div",null,[e[0]||(e[0]=t("h1",null,"Learning Lab",-1)),e[1]||(e[1]=t("div",{style:{"margin-bottom":"30px"}}," Welcome to the Learning Lab — a space dedicated to hands-on projects created for the sake of learning. Each project here was built with the goal of exploring a new concept, technology, or tool. Some are simple, some are experiments, but all helped me grow as a developer. ",-1)),l(i,{projects:a.projects},null,8,["projects"])])}const y=c(m,[["render",h]]);export{y as default};
