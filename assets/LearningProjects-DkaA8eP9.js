import{P as i,a as s}from"./ProjectsList-BtJd-ka_.js";import{e as o,_ as c,c as r,a,d as l,r as p,o as g}from"./index-CjH7Hwcj.js";const d=[new i("learning-1","Tic-Tac-Toe","/img/projects/learning-1/tictactoe-icon-2.png",`
        <div class="paragraph">
        ...
        `,"#23bd69")],m=o({name:"LearningProjects",components:{ProjectsList:s},data:function(){return{projects:d}}});function h(t,e,u,T,b,f){const n=p("ProjectsList");return g(),r("div",null,[e[0]||(e[0]=a("h1",null,"Learning Lab",-1)),e[1]||(e[1]=a("div",{style:{"margin-bottom":"30px"}}," Welcome to the Learning Lab — a space dedicated to hands-on projects created for the sake of learning. Each project here was built with the goal of exploring a new concept, technology, or tool. Some are simple, some are experiments, but all helped me grow as a developer. ",-1)),l(n,{projects:t.projects},null,8,["projects"])])}const y=c(m,[["render",h]]);export{y as default};
